 ...
 * department login for that same person is a DUPLICATE — one person showing up
 * twice, once under Employee and once under their department. This sync
 * therefore does NOT create department logins. It only finds department logins that should be
 ...
 *
 * Admin department logins are NEVER offered for removal — HR and CEO accounts
 * are protected, since those are real login accounts that may legitimately
 * have no Employee record.
 */
const ADMIN_PROTECTED_DEPT_KEYS = new Set(["hr", "ceo"]);
