...
// (C1/C2/C3 from the admin side, C4 from this module). Each bleach is
// self-describing, so no admin-side models are needed here.
//
...
// ═════════════════════════════════════════════════════════════════════════════
// EXTERNAL RULES (read-only) — C1/C2/… scoring rules defined on the admin side.
