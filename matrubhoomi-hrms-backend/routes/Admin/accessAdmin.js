...
/* ================================================================== */
//
// Departments used to be all-or-nothing: you either held one or you did not.
// These three routes are the whole admin surface for the graded vocabulary
// that replaced it — owner / approver / editor / viewer — so there is one
// screen, one vocabulary and one shape of answer for every department.
