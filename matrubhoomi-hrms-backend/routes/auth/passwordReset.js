...
//
// Self-service "forgot password" for the main CMS login (Sign in to Matrubhoomi —
...
const BREVO_SENDER = {
  name: "Matrubhoomi Farms & Developers",
  email: process.env.CUSTOMER_SENDER_EMAIL || "no-reply@matrubhoomifarms.in",
};
...
<div style="background:#0f172a;padding:24px 28px;">
  <p style="margin:0;color:#94a3b8;font-size:11px;letter-spacing:2px;text-transform:uppercase;">Matrubhoomi · Manufacturing Suite</p>
  ...
  try {
    const response = await axios.post(
      `${BREVO_BASE}/smtp/email`,
      {
        ...
        subject: "Your Matrubhoomi Farms & Developers password reset code",
