...
async function uploadToCloudinary(buffer, { folder = "matrubhoomi", resourceType = "auto", originalName = "" } = {}) {
...
async function getOrCreateAttachmentsFolder(drive) {
    try {
        const search = await drive.files.list({
            q: "name='Matrubhoomi Attachments' and mimeType='application/vnd.google-apps.folder' and trashed=false",
