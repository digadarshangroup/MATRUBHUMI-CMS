...
//
//   node scripts/createPlatformAdmin.js --email you@matrubhoomifarms.in --password "..."
//   node scripts/createPlatformAdmin.js --email ceo@matrubhoomifarms.in            (existing account)
//
...
async function main() {
  ...
  if (!email) {
    console.error(
      "\n  Usage:\n" +
      '    node scripts/createPlatformAdmin.js --email you@matrubhoomifarms.in --password "a-long-password"\n\n' +
      "  To promote an account that already exists, the password is optional:\n" +
      "    node scripts/createPlatformAdmin.js --email ceo@matrubhoomifarms.in\n",
    );
    process.exit(1);
  }
