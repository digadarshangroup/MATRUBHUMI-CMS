...
//     node scripts/fixLogin.js --email someone@matrubhoomifarms.in --reactivate
//
//   Set a fresh sign-in password (stored as a bcrypt hash, temporaryPassword
//   cleared):
//     node scripts/fixLogin.js --email someone@matrubhoomifarms.in --set-password "NewPass123"
//
//   Assign the department they sign in to (by slug), if it was lost:
//     node scripts/fixLogin.js --email someone@matrubhoomifarms.in --assign-dept hr
//
//   Flags combine:
//     node scripts/fixLogin.js --email someone@matrubhoomifarms.in --reactivate --set-password "NewPass123"
//
...
async function main() {
  ...
  if (!email) {
    console.error('\n  node scripts/fixLogin.js --email someone@matrubhoomifarms.in [--reactivate] [--set-password "X"] [--assign-dept slug]\n');
    process.exit(1);
  }
