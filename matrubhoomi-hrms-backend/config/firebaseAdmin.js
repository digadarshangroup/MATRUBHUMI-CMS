// MATRUBHOOMI-HRMS-BACKEND/config/firebaseAdmin.js
...
if (!admin.apps.length) {
  ...
  admin.initializeApp({
    ...
    databaseURL: process.env.FIREBASE_DATABASE_URL || "https://matrubhoomi-hrms-38f45-default-rtdb.firebaseio.com" // Add this line
  });
}
